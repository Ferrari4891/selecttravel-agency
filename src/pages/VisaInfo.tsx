  ...
  const visaRequirements = [
    {
      ...
      requirements: [
        ...
        "ESTA authorization or appropriate visa",
    ...
    },
    {
      ...
      requirements: [
        ...
        "Appropriate visa (tourist, business, etc.)",
    ...
    },
    {
      ...
      requirements: [
        "Valid passport (6+ months validity)",
        "Tourist visa (if required)",
        "Yellow fever vaccination (from certain countries)",
        "Proof of sufficient funds"
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        <div className="grid gap-6">
          {visaRequirements.map((country, index) => (
              ...
              <CardContent>
                <div>
                  ...
                  <ul className="space-y-2">
                    {country.requirements.map((requirement, reqIndex) => (
