    ...
    <Card className="w-full max-w-md mx-auto bg-white/95 backdrop-blur-sm border-2 border-white rounded-none shadow-lg">
      <CardContent className="p-6 space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="w-16 h-16 mx-auto bg-black flex items-center justify-center rounded-none">
            <div className="text-white text-xs font-bold">LOGO</div>
          </div>
          <h2 className="text-xl font-bold text-black">Find Restaurants & Bars</h2>
          <p className="text-sm text-muted-foreground">In 15 seconds or less</p>
          <p className="text-xs text-muted-foreground">Discover the perfect dining experience in your chosen destination</p>
        </div>
        ...
        <div className="space-y-2">
          <label className="text-sm font-semibold text-foreground">Select Country</label>
        ...
        {/* Cuisine Selection */}
        <div className="space-y-2">
          <label className="text-sm font-semibold text-foreground">Select Cuisine</label>
        ...
        {/* Number of Results */}
        <div className="space-y-2">
          <label className="text-sm font-semibold text-foreground">Number of Results</label>
        ...
        <div className="flex gap-3">
          <Button 
            ...
            className="flex-1 h-12 text-base font-bold bg-green-500 text-white border-green-500 rounded-none hover:bg-green-600 disabled:opacity-50"
          >
            {isLoading ? (
              <>
          ...
          <Button 
            onClick={handleReset}
            variant="outline"
            className="flex-1 h-12 text-base font-bold bg-background text-foreground border-2 border-border rounded-none hover:bg-muted"
          >
