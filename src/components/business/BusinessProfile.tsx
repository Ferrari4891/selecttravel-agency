...
const countries = [
  ...
  'Argentina', 'Armenia', 'Ascension Island', 'Australia', 'Austria', 'Azerbaijan',
  'Bahamas', 'Bangladesh', 'Barbados', 'Belgium', 'Bermuda', 'Bhutan', 'Bolivia',
  ...
  'France', 'French Guiana', 'Gabon', 'Germany', 'Ghana', 'Gibraltar', 'Greece',
  'Greenland', 'Grenada', 'Guam', 'Guyana', 'Haiti', 'Hong Kong', 'Hungary',
  'Iceland', 'India', 'Indonesia', 'Iran', 'Iraq', 'Ireland', 'Israel', 'Italy',
  'Ivory Coast', 'Jamaica', 'Japan', 'Jordan', 'Kenya', 'Kiribati', 'Laos', 'Latvia',
  'Lebanon', 'Lesotho', 'Libya', 'Liechtenstein', 'Lithuania', 'Luxembourg',
  'Madagascar', 'Malaysia', 'Maldives', 'Mali', 'Malta', 'Marshall Islands',
  'Mauritius', 'Mayotte', 'Mexico', 'Micronesia', 'Monaco', 'Morocco', 'Mozambique',
  'Myanmar', 'Namibia', 'Nauru', 'Nepal', 'Netherlands', 'New Zealand', 'Niger',
  'Nigeria', 'Northern Mariana Islands', 'Norway', 'Pakistan', 'Palau', 'Panama',
  'Papua New Guinea', 'Paraguay', 'Peru', 'Philippines', 'Poland', 'Portugal',
  'Puerto Rico', 'Republic of the Congo', 'Reunion', 'Romania', 'Russia', 'Rwanda',
  'Saint Helena', 'Saint Kitts and Nevis', 'Saint Lucia', 'Saint Vincent and the Grenadines',
  'Samoa', 'San Marino', 'Saudi Arabia', 'Senegal', 'Serbia', 'Seychelles', 'Singapore',
  'Slovakia', 'Slovenia', 'Solomon Islands', 'South Africa', 'South Georgia', 'South Korea',
  'Spain', 'Sri Lanka', 'Sudan', 'Suriname', 'Swaziland', 'Sweden', 'Switzerland',
  'Syria', 'Tanzania', 'Thailand', 'Tonga', 'Trinidad and Tobago', 'Tristan da Cunha',
  'Tunisia', 'Turkey', 'Tuvalu', 'UAE', 'Uganda', 'Ukraine', 'United Kingdom',
  'United States', 'Uruguay', 'US Virgin Islands', 'Vanuatu', 'Vatican City',
